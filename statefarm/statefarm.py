...
DATA_DIR = '/home/chicm/ml/deeplearningcourse/statefarm/data/sf'
...
def create_validation_data():
    drivers_ds = pd.read_csv('/home/chicm/ml/deeplearningcourse/statefarm/data/driver_imgs_list.csv')
    drivers_ds.head
...
def gen_vgg_features(gen_train=True, gen_valid=True, gen_test=True):
...
def gen_submit(clip_percentage, submit_filename):
...
parser.add_argument("--gentestfeats", action ='store_true', help="generate vgg conv layers output array for test data")
parser.add_argument("--gentrainfeats", action ='store_true', help="generate vgg conv layers output array for train and validation data")
...
if args.gentestfeats:
    print args.gentestfeats
if args.gentrainfeats:
    print args.gentrainfeats
if args.train:
    print args.train
if args.predict:
    print args.predict
