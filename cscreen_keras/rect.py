...
TRAIN_DATA = "/home/chicm/ml/cnnpractices/cervc/data/full/train"
VAL_DATA = "/home/chicm/ml/cnnpractices/cervc/data/full/valid"
TEST_DATA = "/home/chicm/ml/cnnpractices/cervc/data/full/test"
train_files = glob(os.path.join(TRAIN_DATA, "*", "*.jpg"))
test_files = glob(os.path.join(TEST_DATA, "*", "*.jpg"))
val_files = glob(os.path.join(VAL_DATA, "*", "*.jpg"))
